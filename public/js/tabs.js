...
function initTabs() {
    ...
    for (var i = 0; i < tabs.length; i++) {
        ...
        if (tabs[i].hasAttribute('data-default') || typeof window.hashTable.activetab !== "undefined") {
            if (typeof window.hashTable.activetab !== "undefined") {
                defaultItem = window.hashTable.activetab;
            }
            else {
